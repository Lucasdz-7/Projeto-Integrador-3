...
> Nesta etapa, será desenvolvido gráficos, análises DEA e filtros interativos para apoiar a análise da segurança viária no Brasil.

### ⚙️ Funcionalidades principais
- Visualização da taxa de mortalidade no trânsito por estado.
- Análise de eficiência em segurança viária com modelo DEA dos 15 melhores municípios.
- Gráficos de sinistros por dia da semana e período do dia.
- Filtros interativos por ano, estado e região para análises comparativas.  
...
|------|----------------------------------------------------------------------------------------------------------------------------------|------------|-------------|
| US6  | Como Coordenador do Projeto: Quero visualizar um gráfico de taxa de mortalidade por estado.                                      | Alta       | 2 pontos    |
| US7  | Como Coordenador do Projeto: Quero analisar a eficiência viária com modelo DEA.                                                  | Alta       | 2 pontos    |
| US8  | Como Coordenador do Projeto: Quero identificar períodos com maior ocorrência de sinistros.                                       | Alta       | 2 pontos    |
| US9  | Como Coordenador do Projeto: Quero visualizar a população do recorte selecionado.                                                | Média      | 1 pontos    |
| US10 | Como Coordenador do Projeto: Quero aplicar filtros por ano, estado e região.                                                     | Baixa      | 2 pontos    |
...
|--------|----------------------------------------------------------------|-----------|
| 01     | Desenvolvimento de gráficos e indicadores de segurança viária. | Concluído |
| 01     | Implementação da análise DEA dos municípios mais eficientes.   | Concluído |
| 01     | Criação de filtros interativos e visualizações comparativas    | Concluído |
