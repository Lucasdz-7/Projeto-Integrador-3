...
| 12   | Baixa      | Como Coordenador do Projeto: Quero ver a população total do recorte selecionado para contextualizar os indicadores apresentados.                                                                                                                                 | 1          | 2      |
| 13   | Baixa      | Como Coordenador do Projeto: Quero aplicar filtros de ano, estado, e região para analisar os dados de forma personalizada e comparativa.                                                                                                             | 2          | 2      |
