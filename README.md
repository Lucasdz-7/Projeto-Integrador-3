...
| 11   | Baixa      | Como Coordenador do Projeto: Quero aplicar filtros de ano, estado, e região para analisar os dados de forma personalizada e comparativa.                                                                                                             | 2          | 2      |
| 12   | Alta      | Como Coordenador do Projeto: Quero visualizar a análise de eficiência em segurança viária utilizando o modelo DEA para idetificar os 20 municípios com mais de 250 mil habitantes com melhor desempenho no país, por meio de uma tabela no dashboard.            | 2          | 3      |
| 13   | Alta      | Como Coordenador do Projeto: Quero visualizar um mapa cloroplético que indique a taxa de letalidade, mortalidade e quantidade de sinistros de cada estado e região, para identificar de forma visual as áreas com maior criticidade no trânsito.          | 3          | 3      |
| 14   | Alta      | Como Coordenador do Projeto: Quero visualizar um gráfico de correlação de Pearson com a frota no eixo X e a quantidade de sinistros no eixo Y, para analisar a relação entre essas variáveis.                                                                   | 2          | 3      |
...
|-------------------|------------|----------|-----------|
| 00                | 24/03/2026 | Concluído  | [MVP](MVP/sp1.md)  |
